...
constraint km004_orgposition_pk primary key (organization_cd, position_cd, employee_id, start_yearmonth)
);

comment on table km004_orgposition is '組織役職マスタ';
comment on column km004_orgposition.organization_cd is '組織cd';
