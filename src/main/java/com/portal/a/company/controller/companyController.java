...
public class companyController {
    ...
    public String getCompanyListByEnvid(@ModelAttribute SelectCompanyForm form, BindingResult bindingResult, Model model) {
    ...
    public String postSignUp(@ModelAttribute @Validated InputCompanyForm form, BindingResult bindingResult, Model model) {
