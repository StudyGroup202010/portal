...
//
//        // 役職マスタ情報を取得
//        List<Position> positionList = positionService.selectBy(form.getPosition_name(), form.getBiko());
//
//        // Modelに役職マスタリストを登録
//        model.addAttribute("positionList", positionList);
//
...
//    public String postSignUp(@ModelAttribute @Validated InputPositionForm form, BindingResult bindingResult,
//            Model model) {
//
...
//        position.setStart_yearmonth(form.Start_yearmonth()); // 開始年月
//        position.setEnd_yearmonth(form.End_yearmonth()); // 最終年月
...
//    public String postPositionDetailUpdate(@ModelAttribute @Validated InputPositionForm form, BindingResult bindingResult,
//            Model model) {
//
